...
## 2. 한국어 번역 — 해결됨 (2026-07-17, 전면 번역 + 번역투 제거 패스)

전면 번역 완료(0c04395·7247690 등) 후 번역투 제거 패스 완료(1319034): 안내 산문은 합니다체로 통일, 공시 보고서 본문만 문서체 유지, 칼크 은유("네 손에 나뉜다"·"보호막이 찢어진다"·"델타를 짓뭉갠다" 등) 자연화. 라벨·숫자·기호는 EN 유지 원칙 그대로. 추가로 ParamRow에 동그라미 물음표 도움말(호버/클릭 툴팁, EN·KO 사전 병기) 탑재(7c28dfd). 남은 것 없음.
