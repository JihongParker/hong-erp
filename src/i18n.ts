...
export const KO_TOUR: { title: string; body: string }[] = [
  ...
  {
    title: '배리어 앞까지 가 보기',
    body: '지금 강조된 두 탭 중 오른쪽 Double-KO 퀀토(리서치) 탭을 여세요. 왼쪽 패널의 WTI 스팟 S₁ 슬라이더를 밀어 올려 상단 배리어에 가까이 가면, 배리어 리스크 모니터가 위험 단계까지 차오르고 델타가 거꾸로 움직이기 시작합니다. 교과서 공식이 무너지는 바로 그 지점입니다.',
  },
  {
    title: '숫자를 따라가 보기',
