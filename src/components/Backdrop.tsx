...
// Four shapes only, anchored to the corners so they never sit behind a heading
// or body text — decoration at the margins, not noise across the copy.
const SHAPES: { kind: Kind; x: number; y: number; size: number; depth: number; dur: number; hue: string; flip?: boolean }[] = [
  { kind: 'co2', x: 85, y: 7, size: 140, depth: 22, dur: 18, hue: BLUE },
  { kind: 'leaf', x: 3, y: 80, size: 150, depth: 12, dur: 21, hue: GREEN },
  { kind: 'waves', x: 30, y: 95, size: 210, depth: 8, dur: 17, hue: BLUE },
  { kind: 'pump', x: 83, y: 85, size: 175, depth: 10, dur: 25, hue: AMBER },
]
